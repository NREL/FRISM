...
def tt_cal(org_geoID, dest_geoID, sel_tt):
    try:
        ...
        travel_time =500
    return travel_time
def assign_store(dest,df_group,loc_df, tt_df):
...
def on_demnad_output (df_input,CBGzone_df, loc_group, loc_df,tt_df,goods_type ):
    ...
    if df_input.shape[0]>0:
        for i in range(0,df_input.shape[0]):
            ...
            org_x, org_y, org_geoid, tt=assign_store(dest_geoid,loc_group,loc_df,tt_df)
            if org_x !=0:
