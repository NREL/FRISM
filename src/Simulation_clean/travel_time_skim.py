...
# %%
travel_file= "../../../FRISM_input_output_SF/Sim_inputs/Geo_data/SFBay_od_dist.csv"
tt_df = pd.read_csv(travel_file)
tt_df=tt_df.rename(columns={"OriginZone":"Origin"})
tt_df=tt_df.rename(columns={"DestinationZone":"Destination"})
tt_df.to_csv("../../../FRISM_input_output_SF/Sim_inputs/Geo_data/SFBay_od_dist.csv", index=False)
# %%
travel_file= "../../../FRISM_input_output_AT/Sim_inputs/Geo_data/Austin_od_dist.csv"
tt_df_at = pd.read_csv(travel_file)
# %%
