...
def main(args=None):
    ...
    df_hh = input_files_processing_hh("../../../FRISM_input_output_AT/Sim_inputs/austin_2018/households.csv.zip")
    ...
    # Read and process synth household
    df_per= input_files_processing_per(df_hh, "../../../FRISM_input_output_AT/Sim_inputs/austin_2018/persons.csv.zip")
