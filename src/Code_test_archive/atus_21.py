...
# %%
fdir_input= "../../../FRISM_input_output_SF/Model_inputs/ATUS/2021/"
atus_act= pd.read_csv(fdir_input+'atusact_2021.dat', sep=',', engine='python')
atus_resp= pd.read_csv(fdir_input+'atusresp_2021.dat', sep=',', engine='python')
#atus_rost= pd.read_csv(fdir_input+'atusrost_2019.dat', sep=',', engine='python')
atus_cps= pd.read_csv(fdir_input+'atuscps_2021.dat', sep=',', engine='python')
# %%
'''
...
atus_df.to_csv(fdir_input+"atus_df_processed_jul_21.csv")
