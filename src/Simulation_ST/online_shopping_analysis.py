...
df_per_by_block=df_per_final.groupby(['GEOID'])['D_num_goods'].agg(num_delivery='sum').reset_index()
...
# %%
df_per_by_block=df_per_final.groupby(['GEOID'])['D_num_groc'].agg(num_delivery='sum').reset_index()
CBGzone_delivery = CBGzone_df.merge(df_per_by_block[['GEOID','num_delivery']], on='GEOID', how='left')
CBGzone_delivery.plot(column='num_delivery', legend=True, cmap='Reds')
# %%
df_per_by_block=df_per_final.groupby(['GEOID'])['D_num_food'].agg(num_delivery='sum').reset_index()
CBGzone_delivery = CBGzone_df.merge(df_per_by_block[['GEOID','num_delivery']], on='GEOID', how='left')
CBGzone_delivery.plot(column='num_delivery', legend=True, cmap='Reds')
...
df_per_by_block=df_per_final.groupby(['GEOID']).agg(num_delivery=('D_num_goods','sum'),
...
CBGzone_delivery.plot(column='delivery_capita', legend=True, cmap='Blues')

# %%

df_per_by_block=df_per_final.groupby(['GEOID']).agg(num_delivery=('D_num_groc','sum'),
                                              num_people=('GEOID','count')).reset_index()
df_per_by_block['delivery_capita']=df_per_by_block['num_delivery']/df_per_by_block['num_people']
#df_per_by_block= df_per_by_block[df_per_by_block['delivery_capita']<1]
CBGzone_delivery = CBGzone_df.merge(df_per_by_block[['GEOID','delivery_capita']], on='GEOID', how='left')
...
df_per_by_block=df_per_final.groupby(['GEOID']).agg(num_delivery=('D_num_food','sum'),
                                              num_people=('GEOID','count')).reset_index()
df_per_by_block['delivery_capita']=df_per_by_block['num_delivery']/df_per_by_block['num_people']
#df_per_by_block= df_per_by_block[df_per_by_block['delivery_capita']<1]
CBGzone_delivery = CBGzone_df.merge(df_per_by_block[['GEOID','delivery_capita']], on='GEOID', how='left')
