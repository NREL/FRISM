...
def web_model(df_hh_state,state_CBSA,study_CBSA,selected_x_var_hh):
    ...
    filename = '../Simulation_{}/webuse_model.sav'.format(config.study_region)
...
def online_model(df_per_state,state_CBSA,study_CBSA,selected_x_var_per):
    ...
    filename = '../Simulation_{}/online_shop_model.sav'.format(config.study_region)
...
def delivery_model(df_per_state,state_CBSA,study_CBSA,selected_x_var_per):
    ...
    filename = '../Simulation_{}/delivery_freq_model.sav'.format(config.study_region)
...
def main(args=None):
    ...
    # df_hh_state, df_per_state = input_files_processing("../../../FRISM_input_output_ST/Model_inputs/NHTS/hhpub.csv",
    #                                                     "../../../FRISM_input_output_ST/Model_inputs/NHTS/perpub.csv",
    #                                                     state_CBSA,x_var_candidate_hh, x_var_candidate_per)
    # household_file="../../../FRISM_input_output_ST/Model_inputs/NHTS/hhpub.csv"
