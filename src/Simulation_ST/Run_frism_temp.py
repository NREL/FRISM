...
#     -hf ../../../FRISM_input_output_ST/Model_inputs/NHTS/hhpub.csv \
#         -pf ../../../FRISM_input_output_ST/Model_inputs/NHTS/perpub.csv \
#             -mt WOD")
...
#     -hf ../../../FRISM_input_output_ST/Sim_inputs/hh_pop/Seattle_2018/households.csv \
#         -pf ../../../FRISM_input_output_ST/Sim_inputs/hh_pop/Seattle_2018/persons.csv \
#           -yr 2018")
...
# for county in [61, 33, 53, 35]:
#   os.system("python Shipment2Fleet_veh_tech_v3.py \
#           -sn {0} \
#               -yt {1} \
#       -st B2C \
#           -ct {2} \
...
## B2C
# for county in [61, 33, 53, 35]:
#   os.system("python VRP_OR-tools_Stops_veh_tech_hpc.py \
#       -cy {2} \
