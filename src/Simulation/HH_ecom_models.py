...
def web_model(df_hh_state,state_CBSA,study_CBSA,selected_x_var_hh):
    ...
    val_hh.to_csv('../Sim_outputs/Generation/%s_webuse_by_income_observed.csv' %config.study_region, index = False, header=True)
    ### Save Studay region data for validation 
    df_hh_study.to_csv('../../FRISM_DATA/Model_inputs/NHTS/%s_hh.csv' %config.study_region, index = False, header=True)
...
def online_model(df_per_state,state_CBSA,study_CBSA,selected_x_var_per):
    ...
    val_per.to_csv('../Sim_outputs/Generation/%s_online_by_income_observed.csv' %config.study_region, index = False, header=True)

    ### Save Studay region data for validation 
    df_per_study.to_csv('../../FRISM_DATA/Model_inputs/NHTS/%s_per.csv' %config.study_region, index = False, header=True)
