...
#     -hf ../../../FRISM_input_output_SF/Sim_inputs/hh_pop/sfbay_2040/households.csv \
#         -pf ../../../FRISM_input_output_SF/Sim_inputs/hh_pop/sfbay_2040/persons.csv \
#           -yr 2040")
                    ...
                    -cr ../../Example_Data/Sim_outputs/Shipment2Fleet/{1}/B2C_carrier_county{2}_shipall_s{0}_y{1}_sr{3}.csv \
                        -pl ../../Example_Data/Sim_outputs/Shipment2Fleet/{1}/B2C_payload_county{2}_shipall_s{0}_y{1}_sr{3}.csv \
                            -vt ../../Example_Data/Sim_outputs/Shipment2Fleet/{1}/vehicle_types_s{0}_y{1}.csv \
                                         -sn {0}\
                                           -yt {1} \
                                            -ps ../../Example_Data/Sim_inputs/Stops_data/".format(scenario, year, county, sample_rate))
#B2B
os.system("python VRP_OR-tools_Stops_veh_tech.py \
    -cy {2} \
        -t ../../Example_Data/Sim_inputs/Geo_data/tt_df_cbg.csv.gz \
            -d ../../Example_Data/Sim_inputs/Geo_data/Austin_od_dist.csv \
                -ct ../../Example_Data/Sim_inputs/Geo_data/Austin_freight_centroids.geojson \
                    -cr ../../Example_Data/Sim_outputs/Shipment2Fleet/{1}/B2B_carrier_county{2}_shipall_A_s{0}_y{1}_sr{3}.csv \
                        -pl ../../Example_Data/Sim_outputs/Shipment2Fleet/{1}/B2B_payload_county{2}_shipall_A_s{0}_y{1}_sr{3}.csv \
                            -vt ../../Example_Data/Sim_outputs/Shipment2Fleet/{1}/vehicle_types_s{0}_y{1}.csv \
                                -sn {0} \
                                    -yt {1} \
                                     -ps ../../Example_Data/Sim_inputs/Stops_data/".format(scenario, year, county, sample_rate))
