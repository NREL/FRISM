...
for county in [13, 41, 55, 75, 81, 85, 95, 97]:
    ...
    #                     -cr ../../../FRISM_input_output/Sim_outputs/Shipment2Fleet/B2C_carrier_county%s_shipall.csv \
    #                         -pl ../../../FRISM_input_output/Sim_outputs/Shipment2Fleet/B2C_payload_county%s_shipall.csv \
