...
import sys
# %%
def externalzone_distibution(group_id): # regional specific: need to update
    ...
    if group_id ==1:
        ...
        if  eval_prob<=0.429:
            return 209069
        elif eval_prob>0.429 and eval_prob<=0.764:
            return 209082
        elif eval_prob>0.764 and eval_prob<=0.840:
            return 209089
        else:
            return 209099 
...
def covert_mesozone_to_local_taz(carrier_df, payload_df, gdf_TAZ):
    ...
    # BRMPO temporary solution to reslove location outside of TAZ but within the county 33015 and 33011
    gdf_joined['taz']= gdf_joined['taz'].fillna(209010)
    ...
    # BRMPO temporary solution to reslove location outside of TAZ but within the county 33015 and 33011
    gdf_joined_payload_1['taz']= gdf_joined_payload_1['taz'].fillna(209010)
...
def ex_seller_zone_to_boundary(sellerzone,df_ex,dic_ex):
    if dic_ex=={}:
        ...
        new_zone=externalzone_distibution(df_ex[df_ex["MESOZONE"]==sellerzone]["Boundary_group"].values[0])
