...
hh.to_csv('../../../FRISM_input_output_AT/Sim_inputs/austin_2040/households.csv', index=True) 
# %% 
per =pd.read_hdf("../../../FRISM_input_output_AT/Sim_inputs/model_data_2040.h5", key="2040/persons")
compression_opts = dict(method='zip',archive_name='persons.csv')  
per.to_csv('../../../FRISM_input_output_AT/Sim_inputs/austin_2040/persons.csv', index=True) 
# %%
# %%
